(function () {
  ...
  function wireUpLogic(root) {
    ...
    // Pay via QR Now click (hybrid: local QR + optional webhook)
    payBtn.addEventListener("click", async () => {
      ...
      try {
        // 1️⃣ Generate EMV & QR LOCALLY (always)
        ...
        // show base merchant first (if we have it)
        ...
        // 2️⃣ Optional: POST to webhook for Merchant + OrderId
